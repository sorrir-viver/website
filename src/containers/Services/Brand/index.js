...
export default (props) => {
  ...
  return [
    <Header key="h" {...props} />,
    <Body key="b">
      <Information visible={informationVisible} onClose={(e) => setInformationVisible(false)} key="i" />
      <Row style={{ width: '1200px', padding: '0 10px' }}>
        <Row type="flex">
          ...
          <Col span={24} style={{ textAlign: 'center', padding: '10px' }}>
            ...
            <Button type="primary" icon="search" onClick={(e) => setInformationVisible(true)} style={{ fontSize: '30px', height: 'unset', marginTop: '20px', padding: '5px 25px' }}>
              Pesquisar
            </Button>
          </Col>
          <Col span={24} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Col
              ...
              <Typography.Paragraph>
                As pessoas tendem a fazer negócios com empresas com as quais estão familiarizadas. Se o sua marca for consistente e fácil de reconhecer, ela pode ajudar as pessoas
                a se sentirem mais à vontade ao comprar seus produtos ou serviços.
              </Typography.Paragraph>
            </Col>
            <Col
              xs={24}
            ...
            <Col
              ...
              <Typography.Paragraph>
                As pessoas adoram contar aos outros sobre as marcas de que gostam. As pessoas usam marcas, comem marcas, ouvem marcas e estão constantemente falando aos outros
                sobre as marcas que amam. Por outro lado, você não pode contar a alguém sobre uma marca que você não consegue lembrar.
              </Typography.Paragraph>
            </Col>
            <Col
              xs={24}
